...
CHECKPOINT_DIR = PROJECT_ROOT / "checkpoints" / "self_distill_v3"
RESULT_DIR = PROJECT_ROOT / "results" / "03_self_kd" / "self_distill_v3"
...
def main() -> None:
    ...
    if CHECKPOINT_DIR.exists() or RESULT_DIR.exists():
        raise FileExistsError(
            f"Refusing to reuse v3 outputs: {CHECKPOINT_DIR} / {RESULT_DIR}"
        )
    ...
    epoch_path = RESULT_DIR / "self_distill_v3_training_log.csv"
    batch_path = RESULT_DIR / "self_distill_v3_training_batch_log.csv"
    tradeoff_path = RESULT_DIR / "self_distill_v3_validation_tradeoff.csv"
    with epoch_path.open("x", newline="", encoding="utf-8") as epoch_handle, \
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if epoch % args.val_every == 0 or epoch == args.epochs:
                ...
                if constraint_met and drop_selection > best_score:
                    ...
                    save_checkpoint_atomic(
                        CHECKPOINT_DIR / "best_self_distill_v3.pth",
                        payload(
            ...
            epoch_handle.flush()
            save_checkpoint_atomic(
                CHECKPOINT_DIR / "last_self_distill_v3.pth",
                payload(
                    epoch, student, optimizer, args, split_sha256,
                    teacher_baseline, constraint_threshold, all_scores,
                    drop_scores, best_epoch, best_score,
