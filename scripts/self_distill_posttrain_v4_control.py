...
from scripts import swin_kd_posttrain_v1 as swin_kd  # noqa: E402
...
CHECKPOINT_DIR = PROJECT_ROOT / "checkpoints" / "self_distill_v4_control"
RESULT_DIR = PROJECT_ROOT / "results" / "03_self_kd" / "self_distill_v4_control"
...
def main() -> None:
    ...
    if CHECKPOINT_DIR.exists() or RESULT_DIR.exists():
        raise FileExistsError(
            f"Refusing to reuse v4-control outputs: {CHECKPOINT_DIR} / {RESULT_DIR}"
        )
    ...
    print(
        f"SELF_TEACHER checkpoint={checkpoint_path} "
    ...
    epoch_path = RESULT_DIR / "self_distill_v4_control_training_log.csv"
    batch_path = RESULT_DIR / "self_distill_v4_control_training_batch_log.csv"
    tradeoff_path = RESULT_DIR / "self_distill_v4_control_validation_tradeoff.csv"
    with epoch_path.open("x", newline="", encoding="utf-8") as epoch_handle, \
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            for step, (images, targets) in enumerate(train_loader, start=1):
                ...
                availability, category = swin_kd.sample_v4_mask(mask_rng, device)
            ...
            if epoch % args.val_every == 0 or epoch == args.epochs:
                ...
                if constraint_met and drop_selection > best_score:
                    ...
                    save_checkpoint_atomic(
                        CHECKPOINT_DIR / "best_self_distill_v4_control.pth",
                        payload(
            ...
            epoch_handle.flush()
            save_checkpoint_atomic(
                CHECKPOINT_DIR / "last_self_distill_v4_control.pth",
                payload(
                    epoch, student, optimizer, args, split_sha256,
                    teacher_baseline, constraint_threshold, all_scores,
                    drop_scores, best_epoch, best_score,
